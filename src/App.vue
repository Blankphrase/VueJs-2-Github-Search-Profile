...
<script>
  ...
  import AppUserProfile from './components/UserProfile.vue'
  import AppUserProfileCounter from './components/UserProfileCounter.vue'
  import AppUserRepositories from './components/UserRepositories.vue'
